drop database if exists pet_lost_and_found_test;
create database pet_lost_and_found_test;
...
insert into `user`(`name`, phone, email) values
    ...
    ('Lucas Gray', '555-876-5432', 'lucas.gray@example.com'),
    ('Emily Johnson', '555-234-5678', 'emily.j@example.com'),
    ('Carlos Smith', '555-345-6789', 'carlos.s@example.com'),
...
insert into post(animal_id, user_id, img_url, `description`, `time`, location_id, gender, size, `found`) values
    ...
    (5, 5, 'https://example.com/images/spike.jpg', 'Our beloved Spike has been missing since last Friday.', '2023-05-01 19:30:00', 5, 'Male', 30, false),
    (6, 6, 'https://example.com/images/ginger.jpg', 'Found a friendly cat in the park, looking for owner.', '2023-05-03 13:20:00', 6, 'Female', 12, true),
    (7, 7, 'https://example.com/images/shadow.jpg', 'Shadow has not returned home since yesterday evening.', '2023-05-04 17:50:00', 7, 'Male', 15, false),
    (1, 8, 'https://example.com/images/buddy2.jpg', 'Just found wandering near downtown. Is he yours?', '2023-05-05 12:00:00', 1, 'Male', 30, true);
