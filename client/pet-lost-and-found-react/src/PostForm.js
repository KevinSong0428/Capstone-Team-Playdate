...
function PostForm() {
  ...
  const addAnimal = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          `Failed to ${post.animal.animalId ? "update" : "create"} animal: ${
            response.status
          }`
        );
      }
  ...
  const addUser = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          `Failed to ${post.user.userId ? "update" : "create"} user: ${
            response.status
          }`
        );
      }
  ...
  const addLocation = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          `Failed to ${
            post.location.locationId ? "update" : "create"
      ...
      console.error(
        `Error ${
          post.location.locationId ? "updating" : "creating"
        } location: `,
        error
      );
    }
